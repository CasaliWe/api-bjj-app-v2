# Documentação da API de Observações para Testes no Postman

Este documento contém exemplos de requisições para testar a API de observações no Postman.

## Configuração Geral

Para todas as requisições, você precisa configurar:
