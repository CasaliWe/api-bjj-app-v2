...
class ObservacoesRepository {
    ...
    public static function adicionar($dados, $userId) {
        try {
            ...
            if (empty($dados['titulo']) || empty($dados['conteudo']) || empty($dados['tag'])) {
                return [
                    'success' => false,
                    'message' => 'Todos os campos são obrigatórios (título, conteúdo e tag)',
                    'data' => null
                ];
            }
    ...
    public static function atualizar($dados, $userId) {
        try {
            // Validação básica dos dados
            if (empty($dados['id']) || empty($dados['titulo']) || empty($dados['conteudo']) || empty($dados['tag'])) {
                return [
                    'success' => false,
                    'message' => 'Todos os campos são obrigatórios (id, título, conteúdo e tag)',
                    'data' => null
                ];
            }
