...
function sendContactEmail($data) {
    ...
    try {
        ...
        // Conteúdo
        $mail->isHTML(true);
        $mail->Subject = 'Novo contato do site - ' . $_ENV['NOME_SITE'];
        $mail->Body = '
        ...
        Logger::log('E-mail de novo contato enviado com sucesso para ' . $data['email'], 'INFO');
        return true;
    } catch (Exception $e) {
        Logger::log('Erro ao enviar e-mail de novo contato: ' . $mail->ErrorInfo, 'ERROR');
        return false;
    }
}