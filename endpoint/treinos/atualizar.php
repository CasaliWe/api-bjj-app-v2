...
// verifica se o método da requisição é POST (usamos POST em vez de PUT para suportar upload de arquivos)
...
// usa o repositório para atualizar o treino com as imagens
use Repositories\TreinoRepository;
$resultado = TreinoRepository::atualizar($dados, $user->id, $imagens);
