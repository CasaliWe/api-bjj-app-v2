...
if (isset($_GET['diaSemana'])) $filtros['diaSemana'] = $_GET['diaSemana'];

$pagina = isset($_GET['pagina']) ? (int)$_GET['pagina'] : 1;
$limite = isset($_GET['limite']) ? (int)$_GET['limite'] : 20;

// usa o repositório para listar os treinos
use Repositories\TreinoRepository;
$resultado = TreinoRepository::listar($user->id, $filtros, $pagina, $limite);
