...
// atualiza os exp do usuário
$res = UserRepository::updateExp($user['id'], $data);
if(!$res) {
    http_response_code(500);
    echo json_encode(['success' => false, 'message' => 'Erro ao atualizar a exp do perfil.']);
    exit;
}

// retorna sucesso
http_response_code(200);
echo json_encode(['success' => true, 'message' => 'Exp do perfil atualizada com sucesso.']);
exit;