...
if(!$res) {
    ...
    echo json_encode(['success' => false, 'message' => 'Erro ao atualizar a visibilidade do perfil.']);
    exit;
}

// retorna sucesso
http_response_code(200);
echo json_encode(['success' => true, 'message' => 'Visibilidade do perfil atualizada com sucesso.']);
exit;