...
if (!isset($data['titulo']) || !isset($data['conteudo']) || !isset($data['tag'])) {
    http_response_code(400);
    echo json_encode(['success' => false, 'message' => 'Todos os campos são obrigatórios (título, conteúdo e tag).']);
    exit;
}

// usa o repositório para adicionar a observação
use Repositories\ObservacoesRepository;
$resultado = ObservacoesRepository::adicionar($data, $user->id);

// Define o código de status HTTP apropriado com base no resultado
