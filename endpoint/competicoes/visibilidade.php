...
// verifica se o ID e a visibilidade foram fornecidos
...
if (!isset($dados['isPublico'])) {
    http_response_code(400);
    echo json_encode(['status' => 'error', 'message' => 'Visibilidade não fornecida.', 'errorCode' => 400]);
    exit;
}

// usa o repositório para alterar a visibilidade da competição
use Repositories\CompeticoesRepository;
$resultado = CompeticoesRepository::alterarVisibilidade($dados['id'], $user->id, (bool)$dados['isPublico']);
